        ...
        <div class="col">
            <div class="">
                <div class="mb-2">
                    ...
                    <small class="text-muted"><i>contoh: Teknik melukis sangat baik | Hasil lukisan sangat bagus.</i></small>
                </div>
                <div class="mb-3">
        ...
        <div class="col">
            <div class="">
                <div class="mb-2">
                    ...
                    <small class="text-muted"><i>contoh: Kombinasi warna yang digunakan sangat tidak cocok | Teknik melukis masih salah.</i></small>
                </div>
                <div class="mb-3">
