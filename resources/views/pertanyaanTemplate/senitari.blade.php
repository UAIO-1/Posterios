...
<form action={{ url('/submitAnswer') }} method="POST" class="form-pertanyaan">
    ...
    <div class="mb-3">
        ...
        <small class="text-muted"><i>contoh: Gerakan sangat bagus | Kostum dan Aksesoris serta musik yang digunakan sangat baik.</i></small>
        <textarea name="strength" class="form-control" style="width: 100%; height: 10%"></textarea>
    </div>

    <div class="mb-3">
        <h6>Kekurangan Proyek</h6>
        <small class="text-muted"><i>contoh: Gerakan sangat tidak serasi | Kostum dan Aksesoris sangat tidak cocok dengan tema.</i></small>
    ...
    <div class="mb-3">
        ...
        <small class="text-muted"><i>contoh: Kamu bisa tampil lebih baik di atas panggung | Dari proyek ini, Anda sangat cocok dalam bidang ini.</i></small>
