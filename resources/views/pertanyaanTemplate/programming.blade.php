...
<form action={{ url('/submitAnswer') }} method="POST">
    ...
    <div class="mb-3">
        <label for="customRange1" class="form-label">1. Dari skala 1 sampai dengan 10, bagaimana ketepatan input, proses, dan output dari proyek?</label>
    ...
    <div class="mb-3">
        <label for="customRange2" class="form-label">2. Dari skala 1 sampai dengan 10, bagaimana elemen-elemen yang dimasukkan dari proyek?</label>
    ...
    <div class="mb-3">
        <label for="customRange3" class="form-label">3. Dari skala 1 sampai dengan 10, bagaimana tampilan antar muka atau <i>user interface</i> dari proyek?</label>
