            ...
            @foreach ($projects as $p)
                <div class="row mt-lg-5">
                    ...
                    <div class="col-md-8">
                        <div class="d-flex justify-content-between">
                            <h1 class="project-title">{{ $p->project_title }}</h1>
                            <a href="" class="btn btn-outline-dark p-3 w-25"  data-bs-toggle="modal" data-bs-target="#exampleModalEditProject">Edit
                ...
                <div class="d-flex justify-content-end mt-lg-5">
                    <a href="#" class="btn btn-danger p-3 w-25"  data-bs-toggle="modal" data-bs-target="#exampleModalDeleteProject">Delete
