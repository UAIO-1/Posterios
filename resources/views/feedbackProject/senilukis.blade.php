...
<div class="text-center">
    <div class="mb-3">
        <label for="customRange1" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana ketepatan kombinasi warna atau pewarnaan dari lukisan tersebut?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange2" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana kesesuaian tema lukisan tersebut dengan alirannya?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange3" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana penguasaan teknik dan bahan dalam proses melukis atau dari lukisan tersebut?
        </label>
        <br>
