...
<div class="text-center">
    <div class="mb-3">
        <label for="customRange1" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana ketepatan input, proses, dan output dari proyek tersebut?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange2" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana elemen-elemen atau komponen-komponen yang digunakan dari proyek tersebut?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange3" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana tampilan antar muka atau <i>user interface</i> dari proyek tersebut?
        </label>
        <br>
