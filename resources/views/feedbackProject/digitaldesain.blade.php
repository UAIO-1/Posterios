...
<div class="text-center">
    <div class="mb-3">
        <label for="customRange1" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana kombinasi warna yang digunakan proyek tersebut?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange2" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana elemen-elemen atau komponen-komponen yang digunakan proyek tersebut?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange3" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana desain yang ditampilkan dari proyek tersebut?
        </label>
        <br>
