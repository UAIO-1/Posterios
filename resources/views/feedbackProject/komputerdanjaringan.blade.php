...
<div class="text-center">
    <div class="mb-3">
        <label for="customRange1" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana kerapian penyusunan kabel dalam jaringan tersebut?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange2" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana teknik yang digunakan dalam membuat jaringan tersebut?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange3" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana kesesuaian hasil dari pengujian yang dilakukan dari jaringan tersebut?
        </label>
        <br>
