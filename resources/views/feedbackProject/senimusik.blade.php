...
<div class="text-center">
    <div class="mb-3">
        <label for="customRange1" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana unsur-unsur musik yang dibawakan dalam proyek?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange2" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana ketepatan tempo yang dibawakan dalam proyek?
        </label>
        <br>
    ...
    <div class="mb-3">
        <label for="customRange3" class="form-label">
            Dari skala 1 sampai dengan 10, bagaimana teknik bermain alat musik atau teknik bernyanyi yang dibawakan dalam proyek?
        </label>
        <br>
