@extends('layout')
@section('title', 'Posting Project • Posterios')
                            ...
                            <form action={{url('/projectPost')}} method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="gender" value="{{ Auth::user()->gender }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted"><em>*setidaknya 6 - 20 karakter</em></small>
                                            @error('project_title')
                                        ...
                                        <div class="mb-3">
                                            <label>Deskripsi Proyek</label> <small class="text-muted"><em>*maks. 10.000 karakter</em></small>
